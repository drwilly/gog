...
SRC_URI="
	${GOG_PN}_en_${PV}_21681.sh
	dlc_musketeer? ( ${GOG_PN}_musketeer_dlc_en_23885_21662.sh )
	dlc_crimsoncourt? ( ${GOG_PN}_the_crimson_court_dlc_en_23885_21662.sh )
	dlc_shieldbreaker? ( ${GOG_PN}_the_shieldbreaker_dlc_en_23885_21662.sh )
	dlc_colorofmadness? ( ${GOG_PN}_the_color_of_madness_dlc_en_23885_21662.sh )
"
